...
/*	@Override
public Object intercept(Invocation invocation) throws Throwable {//invocation有拦截下来的对象
StatementHandler statementHandler=(StatementHandler)invocation.getTarget();
//metaObject方便我们访问属性
...
@Override
public Object plugin(Object target) {//第2步，对要拦截的对象进行过滤

return Plugin.wrap(target, this);
}

@Override
public void setProperties(Properties arg0) {//第1部，拿到一些值
// TODO Auto-generated method stub
