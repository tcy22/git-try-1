...
import com.tcy.bean.CommandContent;
...
public class QueryService {
	...
	public List<Message> queryMessageListByIntercept(String command,String description,Page page) {
		// 组织消息对象
		Message message = new Message();
		message.setCommand(command);
		message.setDescription(description);
		...
		parameter.put("page", page);
		// 分页查询并返回结果
		return messageDao.queryMessageListByIntercept(parameter);
	}
...
/*	public String queryByCommand(String command) {
	...
	public String queryByCommand(String command) {
		...
		System.out.println(Iconst.HELP_COMMAND);
